              ...
              <div className="flex w-full">
                {isEditing ? (
                  <div className="flex w-full flex-col">
                    <textarea
                      ref={textareaRef}
                      className="w-full resize-none whitespace-pre-wrap border-none dark:bg-[#343541] dark:text-white"
                  ...
                  <div className="prose mt-[-2px] w-full dark:prose-invert dark:text-white">
                    {message.content}
                  </div>
                )}
